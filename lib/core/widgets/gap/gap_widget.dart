...
class Gap extends StatelessWidget {
  ...
  ///
  /// The [mainAxisExtent] must not be null and must be positive.
  const Gap.expand(double mainAxisExtent, {Key? key, Color? color}) : this(mainAxisExtent, key: key, crossAxisExtent: double.infinity, color: color);
  ...
  Widget build(BuildContext context) {
    ...
    return _RawGap(mainAxisExtent, crossAxisExtent: crossAxisExtent, color: color, fallbackDirection: fallbackDirection);
  }
}
...
class _RawGap extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    return RenderGap(mainAxisExtent: mainAxisExtent, crossAxisExtent: crossAxisExtent ?? 0, color: color, fallbackDirection: fallbackDirection);
  }
